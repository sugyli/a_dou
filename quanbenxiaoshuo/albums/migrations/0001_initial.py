    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.CharField(default='', help_text='keywords', max_length=255, verbose_name='关键字(seo)')),
                ('description', models.CharField(default='', help_text='description', max_length=255, verbose_name='描述(seo)')),
                ('is_tab', models.BooleanField(db_index=True, default=False, help_text='首页编辑推荐显示', verbose_name='显示在首页')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建时间')),
                ('category', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='album_category', to='albums.Category', verbose_name='类别')),
            ],
            options={
                'verbose_name': '专辑',
