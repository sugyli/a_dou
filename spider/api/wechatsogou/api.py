import random,requests,time,math,re,json

from pprint import pprint
from urllib.request import quote

from .const import agents,WechatSogouConst
from .request import WechatSogouRequest
from .identify_image import identify_image_callback_by_hand,unlock_sogou_callback_example,ws_cache,unlock_weixin_callback_example
from .exceptions import WechatSogouRequestsException,WechatSogouVcodeOcrException,WechatSogouException
from .structuing import WechatSogouStructuring
from .tools import may_int
...
class WechatSogouAPI(object):
    ...
    def __unlock_sogou(self, url, resp, session, unlock_callback=None, identify_image_callback=None):
        ...
        #requests.get(url,headers) 一样 只是 下面的会记录cook
        ...
        # {'code': 0, 'msg': '解封成功，正在为您跳转来源地址...', 'id': 'B337A2B5C7C24CB1302B8B90C759DCDA'}
        #0是验证码输入正确
        if r_unlock['code'] != 0:
            raise WechatSogouVcodeOcrException(
