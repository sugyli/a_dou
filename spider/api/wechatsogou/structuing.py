...
from .tools import get_first_of_element,format_image_url,get_elem_text,list_or_empty,replace_html
...
class WechatSogouStructuring(object):
    ...
    def get_gzh_by_search(text):
        ...
        #{'oIWsFt7Pwv4M83-EvQKXy0nDnXQ4': '2,239', 'oIWsFt1tmWoG6vO6BcsS7St61bRE': '26,365', 'oIWsFt2bm6IOic7WbBJZ9Y0kNpOI': '2,6'}
